...
java $OPTS1 $OPTS2 $OPTS3 -cp lib/webdanica-core-$VERSION.jar:$PHOENIX_CLIENT_JAR:lib/dom4j-1.6.1.jar:lib/jaxen-1.1.jar:lib/lucene-core-4.4.0.jar:lib/commons-io-2.0.1.jar:lib/common-core-$NAS_VERSION.jar dk.kb.webdanica.core.tools.LoadTest $1 $2

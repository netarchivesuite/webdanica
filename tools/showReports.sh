...
NAS_SETTINGSFILE=$TOOLS_HOME_HOME/conf/settings_NAS_Webdanica.xml
...
java $OPTS1 $OPTS2 $OPTS3 -cp lib/webdanica-core-$VERSION.jar:PHOENIX_CLIENT_JAR:lib/dom4j-1.6.1.jar:lib/jaxen-1.1.jar:lib/lucene-core-4.4.0.jar:lib/commons-io-2.0.1.jar:lib/common-core-$NAS_VERSION.jar:lib/harvester-core-$NAS_VERSION.jar:lib/postgresql-9.2-1003-jdbc4.jar:lib/derbyclient-10.12.1.1.jar:lib/jwat-common-1.0.4.jar dk.kb.webdanica.core.tools.HarvestShowReports $1 $2

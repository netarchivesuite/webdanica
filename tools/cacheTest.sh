...
java $OPTS1 $OPTS2 $OPTS3 -cp libs/webdanica-core-1.1-RC4.jar:libs/phoenix-4.7.0-HBase-1.1-client.jar:libs/dom4j-1.6.1.jar:libs/jaxen-1.1.jar:libs/lucene-core-4.4.0.jar:libs/commons-io-2.0.1.jar:libs/common-core-5.1.jar dk.kb.webdanica.core.datamodel.Cache

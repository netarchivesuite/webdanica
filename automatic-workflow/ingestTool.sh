...
java $OPTS2 $OPTS3 -cp lib/webdanica-core-$WEBDANICA_VERSION.jar:lib/phoenix-4.7.0-HBase-1.1-client.jar:lib/commons-io-2.0.1.jar:lib/common-core-5.1.jar:lib/harvester-core-5.1.jar:lib/archive-core-5.1.jar:lib/jwat-common-1.0.4.jar:lib/json-simple-1.1.1.jar:$MAILJAR1:$MAILJAR2 dk.kb.webdanica.core.tools.CriteriaIngestTool $1 $2

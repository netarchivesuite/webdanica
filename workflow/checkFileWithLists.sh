...
java $OPTS1 $OPTS2 $OPTS3 -cp lib/webdanica-core-0.3.0-SNAPSHOT.jar:lib/phoenix-4.7.0-HBase-1.1-client.jar:lib/common-core-5.1.jar:lib/harvester-core-5.1.jar:lib/dom4j-1.6.1.jar:lib/jaxen-1.1.jar:lib/lucene-core-4.4.0.jar dk.kb.webdanica.core.tools.CheckListFileFormat $1

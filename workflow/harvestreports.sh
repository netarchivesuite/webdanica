...
java $OPTS1 $OPTS2 $OPTS3 -cp lib/webdanica-core-0.4.0-SNAPSHOT.jar:lib/slf4j-api-1.7.7.jar:lib/commons-io-2.0.1.jar:lib/common-core-5.1.jar:lib/harvester-core-5.1.jar:lib/derbyclient-10.12.1.1.jar:lib/jwat-common-1.0.4.jar:lib/guava-11.0.2.jar:lib/archive-core-5.1.jar dk.kb.webdanica.core.tools.HarvestShowReports $1

...
public class Configuration {
    ...
    private Configuration() {
         ...
         */
        smtpPort = SettingsUtilities.getIntegerSetting(
                WebdanicaSettings.MAIL_PORT,
                dk.kb.webdanica.core.Constants.DEFAULT_MAIL_PORT);
        smtpHost = SettingsUtilities.getStringSetting(
                WebdanicaSettings.MAIL_SERVER,
                dk.kb.webdanica.core.Constants.DEFAULT_MAIL_HOST);
        mailAdmin = SettingsUtilities.getStringSetting(
        ...
        emailer = Emailer.getInstance(smtpHost, smtpPort, null, null,
                mailAdmin, dontSendMails);
        daoFactory = DatabaseUtils.getDao();

        harvestLogDirName = SettingsUtilities.getStringSetting(
                WebdanicaSettings.HARVESTING_HARVESTLOGDIR,
                Constants.DEFAULT_HARVESTLOGDIR);
        harvestLogPrefix = SettingsUtilities.getStringSetting(
                WebdanicaSettings.HARVESTING_HARVEST_LOG_PREFIX,
                Constants.DEFAULT_HARVESTLOG_PREFIX);
        harvestLogReadySuffix = SettingsUtilities.getStringSetting(
                WebdanicaSettings.HARVESTING_HARVEST_LOG_READY_SUFFIX,
                Constants.DEFAULT_HARVESTLOG_READY_SUFFIX);

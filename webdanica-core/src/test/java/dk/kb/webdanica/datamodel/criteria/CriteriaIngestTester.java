...
public class CriteriaIngestTester {
	...
	public static void main(String[] args) throws IOException, SQLException, ParseException {
		...
		CriteriaIngest.ingest(HarvestLogTest4, baseCriteriaDir1,false);
	...
	private static void runTest3() throws IOException, SQLException, ParseException{
		File basedir = new File("/home/svc/devel/webdanica/criteria-test-11-08-2016");
		String harvestLogName = "harvestlog-1470674884515.txt";
		File HarvestLog = new File(basedir, harvestLogName);
		File baseCriteriaDir = new File(basedir, "11-08-2016-1470934842");
		CriteriaIngest.ingest(HarvestLog, baseCriteriaDir, false);
	}

	private static void runTest2() throws IOException, SQLException, ParseException { 
	...
	private static void runTest1() throws IOException, SQLException, ParseException {
		...
		CriteriaIngest.ingest(danicaHarvestLog, baseCriteriaDir, false);
		CriteriaIngest.ingest(notdanicaHarvestLog, baseCriteriaDir, false);	
	}
	...
	public void test() throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, ParseException {

...
public class CriteriaIngest {
        ...
        while ((line = fr.readLine()) != null) {
            ...
            if (!trimmedLine.isEmpty()) {
                ...
                if (success && doInsert) {
                    ...
                    // log("Url '" + res.url + "' has danishCode: " +
                    // res.calcDanishCode);
                    ...
                    if (addToDatabase) {
                        ...
                        if (!rejected) {
                            decideDanicaStatusFromResult(res, s);
                        }
                        if (insertUrl) {
                            sdao.insertSeed(s);
                        } else {
    ...
    private static void update8c(SingleCriteriaResult res) {
        ...
        if (C8a != null && (!C8a.isEmpty() && !C8a.startsWith("0"))) {
            ...
            log("Updating criteria C8c. Changed from '" + oldC8c + "' to '"
    ...
    private static void update3g(SingleCriteriaResult res) {
        ...
        if (C3g != null && (!C3g.isEmpty() && !C3g.startsWith("0"))) {
            ...
            log("Updating criteria C3g. Changed from '" + oldC3g + "' to '"
                    + C3g + "'");
            res.C.put("C3g", C3g);
        }

 ...
 */
public class LocalArcRepositoryClientReadableOnly implements ArcRepositoryClient {

    /** The logger for this class. */
    private static final Logger log = LoggerFactory.getLogger(LocalArcRepositoryClientReadableOnly.class);
    ...
    public LocalArcRepositoryClientReadableOnly() {
        ...
        for (String fileName : fileDirs) {
            ...
            if (f.isDirectory() && f.canRead()) {
                ...
                log.warn("directory '{}' does not exist or is not readable by the user running this program", f.getAbsolutePath());
            }
        }
    }
    ...
    public void store(File file) throws IOFailure, ArgumentNotValid {
        throw new NotImplementedException("The " +  getClass().getName() + " does not implement this method");
    }

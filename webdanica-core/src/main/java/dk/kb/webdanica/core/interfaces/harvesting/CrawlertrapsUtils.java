/**
 * Copied from Netarchivesuite/harvester/harvester-core/src/main/java/dk/netarkivet/
 * harvester/utils/CrawlertrapsUtils.java,
 * as it is not part of dependency NAS in version 5.1
 */
